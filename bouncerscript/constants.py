ALIASES_REGEXES = {
    ...
    'thunderbird-next-msi-latest-ssl': r'^Thunderbird-\d+\.\d+(\.\d+)?-msi-SSL$',
...
PRODUCT_TO_DESTINATIONS_REGEXES = {
    ...
    'thunderbird': r'^(/thunderbird/releases/.*?/(update/)?(?:linux-i686|linux-x86_64|mac|win32|win64(?:|-aarch64))/\:lang/(?:thunderbird|Thunderbird).*\.(?:bz2|dmg|exe|mar|msi))$',
}
